...
extern "C" struct _MATHTOOL_API Triangle {
	unsigned short a;
	unsigned short b;
	unsigned short c;
	Triangle();
...
extern "C" struct _MATHTOOL_API Vector3f {
	float x;
	float y;
	float z;
	Vector3f();
...
extern "C" struct _MATHTOOL_API Vector4f {
	float x;
	float y;
	float z;
	float w;
...
extern "C" struct _MATHTOOL_API Quaternion {
...
extern "C" struct _MATHTOOL_API TexCoord2f {
	float u;
	float v;
};

extern "C" struct _MATHTOOL_API TexCoord3f {
	float u;
	float v;
	float w;
};

extern "C" struct _MATHTOOL_API Matrix22f {
	float m[2][2];
...
extern "C" struct _MATHTOOL_API Matrix33f {
	float m[3][3];
...
extern "C" struct _MATHTOOL_API Matrix44f {
	float m[4][4];
...
extern "C" struct _MATHTOOL_API Matrix34f {
	float m[3][4];
...
extern "C" struct _MATHTOOL_API Transform {
	Matrix33f rotation;
