...
extern "C" class _CORE_API TWindow : public TThread {
public:
	TWindow();
	virtual ~TWindow();
public:
	TRefArray<TWindow> components;
	TRWLock rwLock;
public:
	//	MGE_MESSAGE
	enum {
...
public:
	...
	virtual void AddComponent(TWindow &src);
public:
	void Command(TMessage &msg);
public://Commands
	...
	virtual void OnLeftButtonBoubleClick();
	virtual void OnRightButtonDown();
	virtual void OnRightButtonUp();
	virtual void OnRightButtonBoubleClick();
	virtual void OnMiddleButtonDown();
	virtual void OnMiddleButtonUp();
	virtual void OnMiddleButtonBoubleClick();
