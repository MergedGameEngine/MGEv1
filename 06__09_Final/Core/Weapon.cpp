...
_CORE_API TWeapon::TWeapon() {
}
_CORE_API TWeapon::~TWeapon() {
}
char _CORE_API *TWeapon::GetClassName() {
	return "TWeapon";
}
int _CORE_API TWeapon::GetClassCode() {
	return CLSID_TWeapon;
}
int _CORE_API TWeapon::GetHashCode() {
	return 1;
}
BOOL32 _CORE_API TWeapon::IsInstanceof(const char* className) {
	if (strcmp("TWeapon", className)) {
		return TRUE;
	}
	return TModelController::IsInstanceof(className);
}
BOOL32 _CORE_API TWeapon::IsEqualto(IObject &obj) {
	return FALSE;
}
void _CORE_API TWeapon::Serialize(IIOStream &iio) {
}
void _CORE_API TWeapon::Wait() {
}
void _CORE_API TWeapon::Notify() {
}
